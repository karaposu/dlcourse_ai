...
class KNN:
    ...
    def predict_labels_binary(self, dists):
        ...
        for i in range(num_test):
            ...
            # now we will check the indexes of smallest n numbers
            # put them in a list.
            # and use these indexes with train data labels to find predicted labels
            ...
            axis = 0
            values_of_k_smallest_values=np.zeros(self.k)

            values_of_k_smallest_values=np.take( dists[i] , filter_indices, axis)
